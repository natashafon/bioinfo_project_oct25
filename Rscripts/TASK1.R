# TASK 1 - Filter, summarize, and group bulk counts
...
# SHOW RESULTS
res_dt <- task1_dt("bulk_counts_long.csv", "sample_metadata.csv")
...
# SHOW RESULTS
res_df <- task1_df("bulk_counts_long.csv", "sample_metadata.csv")
